...
/* ПРИМЕНЕНИЕ: */
// useSelector(usersSelectors.someSelector)

/* таким образом снижается вероятность опечатки, т.к. 
когда воодишь => имяОбъекта.точка => автоматически предлагается выбрать нужное свойство */
